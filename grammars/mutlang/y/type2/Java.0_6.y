...
static_ : modifiers
;
relational_expression : relational_expression INSTANCEOF_TK reference_type | relational_expression GTE_TK shift_expression | relational_expression for_header shift_expression | relational_expression GT_TK shift_expression | relational_expression LT_TK shift_expression | shift_expression
;
