%token CHARSET_SYM STRING WS CDO CDC URI MEDIA_SYM IMPORT_SYM IDENT PAGE_SYM HASH INCLUDES DASHMATCH FUNCTION IMPORTANT_SYM NUMBER PERCENTAGE LENGTH EMS EXS ANGLE TIME FREQ
...
;
selector_tail : combinator selector | WS S_multi selector_tail_2_opt
;
selector_tail_2_opt : | selector_tail_2
;
selector_tail_2 : combinator_opt selector
;
simple_selector : element_name  simple_selector_tail_multi | simple_selector_tail simple_selector_tail_multi
;
...
;
term : unary_operator_opt term_types | STRING S_multi | IDENT S_multi | URI S_multi | hexcolor | function
;
